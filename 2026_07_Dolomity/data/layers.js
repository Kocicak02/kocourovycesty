...
var group_foto = new ol.layer.Group({
                                layers: [lyr_Fotky_2,lyr_Fotky_podle_casu_3,lyr_Videa_4,],
                                fold: 'open',
                                title: 'foto'});
...
lyr_track_1.set('fieldImages', {'name': 'TextEdit', 'cmt': 'TextEdit', 'desc': 'TextEdit', 'src': 'TextEdit', 'link1_href': 'TextEdit', 'link1_text': 'TextEdit', 'link1_type': 'TextEdit', 'link2_href': 'TextEdit', 'link2_text': 'TextEdit', 'link2_type': 'TextEdit', 'number': 'Range', 'type': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
...
lyr_Fotky_2.set('fieldLabels', {'filename': 'no label', 'photo': 'no label', 'path': 'no label', 'photo_time': 'no label', 'bunny_file': 'no label', 'photo_url': 'no label', });
